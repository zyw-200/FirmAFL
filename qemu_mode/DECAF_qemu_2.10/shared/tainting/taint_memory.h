...
//zyw
extern void __taint_ldb_raw(unsigned long addr, gva_t vaddr);
extern void __taint_ldw_raw(unsigned long addr, gva_t vaddr);
extern void __taint_ldl_raw(unsigned long addr, gva_t vaddr);
extern void __taint_ldq_raw(unsigned long addr, gva_t vaddr);
extern void __taint_ldb_raw_paddr(ram_addr_t addr,gva_t vaddr);
extern void __taint_ldw_raw_paddr(ram_addr_t addr,gva_t vaddr);
extern void __taint_ldl_raw_paddr(ram_addr_t addr,gva_t vaddr);
extern void __taint_ldq_raw_paddr(ram_addr_t addr,gva_t vaddr);

extern void __taint_stb_raw(unsigned long addr, gva_t vaddr);
extern void __taint_stw_raw(unsigned long addr, gva_t vaddr);
extern void __taint_stl_raw(unsigned long addr, gva_t vaddr);
extern void __taint_stq_raw(unsigned long addr, gva_t vaddr);
extern void __taint_stb_raw_paddr(ram_addr_t addr,gva_t vaddr);
extern void __taint_stw_raw_paddr(ram_addr_t addr,gva_t vaddr);
extern void __taint_stl_raw_paddr(ram_addr_t addr,gva_t vaddr);
extern void __taint_stq_raw_paddr(ram_addr_t addr,gva_t vaddr);
