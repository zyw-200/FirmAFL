...
// AVB, Global funciton pointer which will be initialized in DECAF
...
void
qemu_close1(TSK_IMG_INFO * img_info)
{
}
...
qemu_image_open(void *opaque, unsigned int a_ssize)
{
    ...
    // This does not matter here, as the size is reset again in DECAF
