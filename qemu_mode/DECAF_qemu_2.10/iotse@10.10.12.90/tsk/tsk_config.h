...
/* Define to 1 if you have the `qcow' library (-lqcow). */
/* #undef HAVE_LIBQCOW */

/* Define to 1 if you have the <libqcow.h> header file. */
/* #undef HAVE_LIBQCOW_H */
...
#define PACKAGE_STRING "sleuthkit 4.1.3"
