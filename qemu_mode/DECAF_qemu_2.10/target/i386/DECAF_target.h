...
static inline int DECAF_is_in_kernel(CPUState *cpu)
{
  CPUArchState *_env = (CPUArchState *)cpu->env_ptr;
...
static inline gva_t DECAF_getPC(CPUState* cpu)
{
  CPUArchState *env = (CPUArchState *)cpu->env_ptr;
  return (env->eip + env->segs[R_CS].base);
}

static inline gpa_t DECAF_getPGD(CPUState* cpu)
{
  CPUArchState *env = (CPUArchState *)cpu->env_ptr;
  return (env->cr[3]);
}

static inline gva_t DECAF_getESP(CPUState* cpu)
{
  CPUArchState *env = (CPUArchState *)cpu->env_ptr;
