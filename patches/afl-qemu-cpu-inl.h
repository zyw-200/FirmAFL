...
int syn_shmem_id = 24871075; 
target_ulong not_gencode_pc = 0;//jjhttpd 0x31000 //0x1000// 0x56000 //0x51000
#endif
...
#ifdef MEM_MAPPING
//zywconfig
abi_ulong afl_entry_point = 0x409528, /* ELF entry point (_start) */
