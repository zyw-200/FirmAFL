#AFL="./afl-fuzz -m none -t 800000+ -Q -i ./inputs -o ./outputs -x http_keywords -M fuzzer01"
#AFL="./afl-fuzz -m none -t 800000+ -Q -i ./inputs -o ./outputs -x http_keywords -S fuzzer02"
#AFL="./afl-fuzz -m none -t 800000+ -Q -i ./inputs -o ./outputs -x http_keywords $1 $2"
AFL="./afl-fuzz -m none -t 800000+ -Q -i ./inputs -o ./outputs -x keywords_9050"
echo $AFL
