...
IMAGE="./image.raw"
MEM_FILE="./mem_file"
AFL="./afl-fuzz-full -m none -t 800000+  -i ./inputs -o ./outputs_full -x keywords_9050 -QQ -- "
...
${AFL} \
 ${QEMU} -m 256 -M ${QEMU_MACHINE} -kernel ${KERNEL} \
    ...
    -aflFile @@ 
#../qemu_mode/DECAF_qemu_2.10/qemu-img convert -f raw -O qcow2 ./scratch/9050/image.raw ./scratch/9050/image.qcow2
#-monitor telnet:127.0.0.1:4444,server
#set follow-fork-mode child
#b roms/u-boot/arch/mips/lib/traps.c:65
