...
AFL="./afl-fuzz-full -m none -t 800000+  -i ./inputs -o ./outputs -x keywords_105600 -QQ --"

${AFL} \
 ${QEMU} -m 256 -mem-prealloc -mem-path ../image_105600/mem_file -M ${QEMU_MACHINE} -kernel ${KERNEL} \
