...
sudo ip addr add 192.168.10.29/24 dev ${HOSTNETDEV_0}

echo "Adding route to 192.168.10.30..."
sudo ip route add 192.168.10.30 via 192.168.10.30 dev ${HOSTNETDEV_0}
...
AFL="./afl-fuzz-full -m none -t 800000+  -i ./inputs -o ./outputs_full -x keywords_129781 -QQ --"
